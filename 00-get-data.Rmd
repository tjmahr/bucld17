...
library("knitr")
opts_chunk$set(
  cache.path = "assets/cache/00-",
  fig.path = "assets/figure/00-",
  warning = FALSE,
  collapse = TRUE, 
  comment = "#>", 
  message = FALSE,
...
This script downloads the raw data from our lab's private database. It cannot be
reproduced by people outside our lab. Therefore, I try to keep the script brief
and have it save the needed data into the folder `data-raw`.
